...
show_select_provider_icon_in_popup = Zobraziť ikonu ďalšieho prekladu
...
pro_version_promo_tooltip = Pripravujeme verziu PRO s celostránkovým prekladom AI. Kliknutím sa dozviete viac a môžete si uplatniť zľavu.
