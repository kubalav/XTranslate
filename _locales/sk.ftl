...
settings_title_full_page_show_traffic_save_mode = Zapnpúť režim "šetrenie dát"
settings_title_full_page_show_traffic_save_mode_info = Úspora nákladov na sieť/API prekladaním iba viditeľných textov webovej stránky.
